function script_run_tLenresults(tLen)
% FUNCTION script_run_tLenresults
...
warpDir = [outDir, 'alignment_raidersP1_5_95_tLen', num2str(tLen), '/'];
destDir = [outDir, 'alignment_raidersP1/'];
movefile(warpDir, destDir);
