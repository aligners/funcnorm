function script_run_acrossSubjReg_on_raidersP1(lambda, mach)
% FUNCTION script_run_acrossSubjReg_on_raidersP1
...
script_connnorm_acrossSubjReg(subjects, hems, train_experiment, mmRes, fwhm, fs_surf, outDir, ...
