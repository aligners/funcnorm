function script_run_connnorm_on_raidersP2(lambda)
% FUNCTION script_run_connnorm_on_raidersP2(lambda)
...
train_volDataDir = '../surf_data/raidersP2/';
train_experiment = 'raidersP2';
train_suffix = '+orig';
...
test_volDataDir = '../surf_data/raidersP1/';
test_experiment = 'raidersP1';
test_suffix = '+orig';
